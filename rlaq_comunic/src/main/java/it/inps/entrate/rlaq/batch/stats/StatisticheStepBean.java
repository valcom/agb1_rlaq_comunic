...
public class StatisticheStepBean extends StatisticheBean {
	...
	public String toString() {
		...
		StringBuilder sb = new StringBuilder(String.format(TEMPLATE_MSG, getName(), timeExec, getTotaleElementiLetti(), getTotaleElementiScritti(), getTotaleElementiInErrore()));
